...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 py-8 border-t-2 border-cyan-400">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/events" className="text-cyan-300 hover:text-magenta-400 font-medium">Events</Link></li>
              <li><Link href="/park-info" className="text-cyan-300 hover:text-magenta-400 font-medium">Park Info</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-cyan-400 mt-8 pt-8 text-center text-cyan-300 text-sm">
