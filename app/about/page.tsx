...
export default function AboutUs() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Stats Section */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12 text-center">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">25</div>
          <div className="text-gray-600 dark:text-gray-300">Obstacles</div>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          <div className="text-gray-600 dark:text-gray-300">Events per year</div>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">2300</div>
          <div className="text-gray-600 dark:text-gray-300">Working hours per year</div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3">ÖV</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-3">Auto</h3>
