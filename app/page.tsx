        ...
        <div className="flex flex-col items-center justify-center py-12 px-4">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-4 -right-4 bg-white/90 px-3 py-1 rounded-full shadow-lg text-sm font-semibold text-gray-800"
            >
              In shape since 1998
            </motion.div>
          </motion.div>
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Welcome to Mythenpark</h1>
          ...
          >
            ...
            <motion.a 
              href="/park-info" 
              className="px-6 py-3 bg-white text-gray-800 rounded-full font-semibold shadow-lg hover:bg-gray-100 transition-all duration-300 border border-gray-200"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Park Information
          ...
          <motion.a 
            ...
            target="_blank"
            className={`flex items-center justify-center px-6 py-3 mt-6 rounded-full transition-all duration-500 ${pulseEffect ? 'scale-105' : 'scale-100'}`}
            style={{
